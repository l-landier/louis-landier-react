  ...
  return (
    <section className="padding-top-xl padding-bottom-xl">
      <Container classType="container">
        <Title tagType="h3" classType="h3">Qui suis-je ?</Title>
        <div className="display-flex-tablet-desktop justify-space-between center-align">
          ...
          <div className="col-xs-12 col-sm-8">
            <p className="margin-bottom-xs">
              ...
              suivie d’une spécialisation d’un an en web-design, en alternance dans une start-up
              spécialisée dans la création de web-app.
            </p>
            <p>
              Ensuite, j’ai exercé dans plusieurs postes les responsabilités de webdesigner et d’intégrateur,
              ce qui m’a ainsi permis d’alterner la maquette et leur intégration. Après avoir acquis une
              solide expérience qui a fait ses preuves, j’ai choisi de me consacrer uniquement à l’intégration
              et à la mise en place des best practices pour améliorer les performances et les interfaces dont
